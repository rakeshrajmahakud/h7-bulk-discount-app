export default function PrivacyPolicy() {
  return (
    ...
    >
      ...
      <p>
        Our app may access Shopify Admin API data only to provide the features
        and services requested by the merchant.
      </p>

      <p>
        We do not sell Shopify merchant or customer data to third parties.
      </p>
      ...
      <p>
        If customer information is processed through Shopify APIs as required
        for an app feature, it is used only for providing that feature and is
        handled in accordance with applicable privacy requirements.
      </p>
      ...
      <p>
        Application data and Shopify session information may be stored in our
        PostgreSQL database infrastructure.
      </p>

      <p>
        We retain information only for as long as necessary to provide the
        application, maintain our services, comply with legal obligations, or
        resolve disputes.
      </p>
      ...
      <p>
        Depending on the location of our infrastructure and service providers,
        information may be processed or stored outside the country where the
        merchant is located, including outside Europe.
      </p>
      ...
      <p>
        ...
        is handled, please contact us through the support contact information
        provided in our Shopify App Store listing.
      </p>
    </main>
  );
}